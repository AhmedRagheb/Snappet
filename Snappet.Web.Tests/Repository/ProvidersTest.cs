...
namespace Snappet.Web.Tests
{
    ...
    public class ProvidersTest
    {
        ...
        public void Init()
        {
            ...
            _studentProvider = StructureMapInjectorTest._container.GetInstance<IStudentsRepository>();
            _pathProvider = StructureMapInjectorTest._container.GetInstance<IPathRepository>();
        }
